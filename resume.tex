...
\begin{center}
  ...
  \begin{tabular*}{6.5in}{l@{\extracolsep{\fill}}r}
    \faLinkedin \ \href{https://www.linkedin.com/in/jckcross}{linkedin.com/in/jckcross} \hspace{0.2in} 
    \faGithub \ \href{https://github.com/jckcross}{github.com/jckcross} \hspace{0.2in}
    \faGlobe \ \href{https://jckcross.github.io/}{jckcross.github.io} \hspace{0.2in} & 
...
\begin{itemize}[leftmargin=0.2in, label={}, itemsep=0.2in]
  \item
    \begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
      ...
      \textit{Civil Engineer} & \textit{Columbus, MS}\\
    \end{tabular*}
...
\begin{itemize}[leftmargin=0.15in, label={}, itemsep=0.1in]
  \item
    ...
    \begin{itemize}[leftmargin=0.2in, label={$\bullet$}, itemsep=0.05in]
      \item GPA: 3.64/4.0
      \item Air Force Institute of Technology Graduate Scholarship Recipient. 10 STEM ROTC cadets selected across the country
    \end{itemize}
  ...
  \item
    ...
    \begin{itemize}[leftmargin=0.2in, label={$\bullet$}, itemsep=0.05in]
      ...
      \item Leadership: Tau Beta Pi Engineering Honor Society (Vice President), ASCE Student Chapter, Kappa Alpha Order
